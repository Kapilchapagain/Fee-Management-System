    ...
    <div className='h-screen w-screen flex  bg-gray-200 items-center justify-center'>
        ...
        <button onClick={()=>setShowReg(false)} className='bg-black text-white border h-10 w-10 '>X</button>
          ...
          <div className='flex flex-col items-center m-2'>
              <h1 className='text-4xl font-bold font-serif'>{obj?"Edit Form":"Add Students"}</h1>
            </div>
            ...
            <div className='flex flex-col items-center font-serif mt-3 '>
              ...
              <input value={obj?obj.email:""} type="text " className='h-10 w-70 border rounded '  />
            </div>
            <div className='flex flex-col items-center mt-3 font-serif'>
              <span className='flex mr-60'>Class</span>
              <input value={obj?obj.class:""} type="password " className='h-10 w-70 border rounded'  />
            </div>
             <div className='flex flex-col items-center mt-3 font-serif'>
              <span className='flex mr-60'>Phone</span>
              <input value={obj?obj.phone:""} type="password " className='h-10 w-70 border rounded'  />
            </div>
             <div className='flex flex-col items-center mt-3 font-serif'>
              <span className='flex mr-55'>Total Fee</span>
              <input value={obj?obj.totalFee:""} type="password " className='h-10 w-70 border rounded'  />
            </div>
             <div className='flex flex-col items-center mt-3 font-serif'>
              <span className='flex mr-49'>Due Amount</span>
              <input value={obj?obj.dueFee:""} type="password " className='h-10 w-70 border rounded'  />
            </div>
            <div className='flex flex-col items-center mt-3 font-serif'>
              <span className='flex mr-48'>Total Amount</span>
              <input value={obj?obj.paidFee:""}  type="password " className='h-10 w-70 border rounded'  />
            </div>
            <div>
